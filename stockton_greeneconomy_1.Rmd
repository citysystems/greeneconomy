...
map = mapview(
  ...
  legend = TRUE, 
  layer.name = 'Average</br>Annual</br>GHG/worker</br>(tCO2e)'
)
...
map = mapview(stockton_lodes_h_counties_ghg_map, zcol = "Total Annual GHG (tCO2e)", map.types = c("OpenStreetMap"), legend = TRUE, layer.name = 'Total Annual</br>GHG (tCO2e)')
...
map = mapview(bg_bldg_norm_r,zcol=c("residential_density"), legend = TRUE, layer.name = "Residential density")
...
map = mapview(bg_bldg_norm_c,zcol=c("commercial_density"), legend = TRUE, layer.name = "Commercial density")
...
```{r summary-TCO2E-norm-projection}
