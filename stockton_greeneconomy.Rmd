...
datatable(iclei_2005_2016, rownames = FALSE, options = list(pageLength = 2))
```
*Table 9. Inventory Comparisons Stockton 2005-2016, from ICLEI.*
...
```{r, warning=FALSE, message=FALSE, error=FALSE, results=FALSE, fig.keep='all'}
...
```{r, warning=FALSE, message=FALSE, results = FALSE, error=FALSE, fig.show='asis'}
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results=FALSE, error=FALSE, fig.show='asis'}
...
stockton_lodes_w_top_counties <-
  stockton_lodes_w_counties[1:8,]

mapview(stockton_lodes_w_top_counties, burst = TRUE, map.types = c("OpenStreetMap"), legend = TRUE, hide = TRUE)
```
