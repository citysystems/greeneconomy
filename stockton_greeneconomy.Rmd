...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-bgs.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-stockton-lodes-w-top-counties-youth.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-stockton-lodes-w-top-counties-lowinc.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-stockton-lodes-w-top-counties-highinc.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-stockton-lodes-w-top-counties-goods.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-stockton-lodes-w-top-counties-trade.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-stockton-lodes-w-top-counties-services.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-stockton-lodes-w-construction-high.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-stockton-lodes-w-scientific-high.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-stockton-jobs-map.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-stockton-commute-avg.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-amenity-vmt-location.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-amenity-vmt-bg.html")
```
...
stockton_naics_ghg <-
  stockton_lodes_h_join_wac_normalize %>% 
  left_join(stockton_lodes_h_bgs_ghg, by = c("w_bg" = "workplace")) %>% 
  group_by(w_bg) %>% 
  summarize_at(
...
kable(
  stockton_naics_ghg_summary_table, 
  booktabs = TRUE, 
  caption = 'Commute tCO2e per Stockton commuter, by NAICS industry and wage tier. Data from LODES, 2017.'
  ) %>% 
  kable_styling() %>%
  scroll_box(width = "100%")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-zcta.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-adu-example.html")
```
...
knitr::include_url("https://city.systems/stockton-greeneconomy/map-accessible-adus.html")
```
...
- At Stockton's climate zone (CZ12) experiences cooler winters and a greater number of heating degree days than Palo Alto, so the estimated savings for electrification should be even greater than estimated in Palo Alto. 
...
As previously noted in Section 2.4, only 23% of Stockton high-wage construction workers work in Stockton. 
