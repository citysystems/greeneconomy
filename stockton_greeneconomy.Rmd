...
```
*Table 16. Stockton Commute One-Way VMT from 2010-2017. Data from LODES and ACS 1-yr.*
...
```
*Figure 18. Stockton Commute One-Way VMT per Employed Resident from 2013-2017. Data from LODES and ACS 1-yr.*
...
hdd <- 
  ...
  filter(year %in% summary_TCO2E_average$YEAR & model == "CanESM2") %>% 
  transmute(
    YEAR = year,
    hdd = degree_days
  )
