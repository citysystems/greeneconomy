...
summary_TCO2E_norm_all %>% 
  ...
  geom_smooth(
    aes(
      y = `Commercial Gas, kBTU/job/HDD`,
      colour = "CG forecast",
      linetype = "CG forecast"
    ),
    method = lm,
    se = FALSE
  ) +
  scale_colour_manual(values = c("red","red","blue","blue", "orange", "orange", "green","green")) +
