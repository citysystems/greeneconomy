...
- From Section 2.6, we derived a linear forecast of PG&E's electricity emissions factor which runs from 2017's data point towards a 2045 target of 100% clean energy.
- From Section 2.6, we derived linear forecasts of heating and cooling degree days through 2040 from Cal-Adapt's HDD and CDD projections.
- From Section 2.6, we derived linear forecasts of energy use per capita per degree-day through 2040. For Commercial Gas, we leveled out the forecast at 1 kBTU/job/HDD from 2035 on.
...
After a description of quantitative methodology, this section is organized by domain of potential green economy strategies. Each section includes case studies from other cities that have explored the strategies in the proposed domain, and after reflection on the lessons learned from these case studies, a specific set of recommended strategies are modeled in terms of their possible impact on GHG reduction and economic benefits. Where possible, short-term and operational costs are also estimated. 

For readers looking for an index of the case studies by case study city for quick reference, see Appendix A.

## Methodology

The previous section has already set up the framework for how we will evaluate the effectiveness of any green economy strategies we might consider. Whatever the strategy may be, it would need to have a predicted effect on one of the variable inputs in our GHG model. The following diagram shows those variables highlighted in yellow, and their business-as-usual trends as up/down arrows.
...
### Case Study: ADUs in San Mateo County, CA
...
The following specific programs from LADWP may be particularly relevant to Stockton's green economy strategy (all numbers come from the FY 2016-17 study):
- The [Efficient Product Marketplace](https://www.ladwp.com/ladwp/faces/ladwp/residential/r-savemoney/r-sm-rebatesandprograms/r-sm-rp-epm?_adf.ctrl-state=bpfmda7pv_4&_afrLoop=251525733328257) is a website platform for customers to find energy efficient products and apply for rebates electronically. Eligible products include LED bulbs, refrigerators, air conditioners, TVs, power strips, and programmable thermostats. LADWP invested $1.2M, garnered \$7.7M in co-investment, saved \$78K in energy costs, supported 50.5 FTE job-years, and added \$5.3 million in value to the LA County economy. The energy savings was estimated at 500,000 kWh, or approximately 43 tCO2e, which means that all in all, the program costs \$85K/tCO2e.
- The [Refrigerator Exchange Program](http://www.ladwpexchange.com/) helps residential customers enrolled in LADWP's "Low Income" and "Life Line" Programs to save energy by replacing their old energy-hogging refrigerator with a new energy-saving unit. The appliances must be at least 10 years old.
- 
