...
#   )
# 
# save(stockton_lodes_h_route,stockton_lodes_h_filter,stockton_lodes_h_mode, file= "C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/LODES/stockton_lodes.Rdata")

load("C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/LODES/stockton_lodes.Rdata")
...
get_stockton_vmt <- function(year){
  ...
  save(stockton_lodes_h_route,stockton_lodes_h_filter,stockton_lodes_h_mode, file = paste0("C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/LODES/stockton_lodes_",year,".Rdata"))
...
# save(stockton_commute_vmt, file = "C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/LODES/stockton_commute_vmt.Rdata")
load("C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/LODES/stockton_commute_vmt.Rdata")
...
#   data.frame(
#     year = 2013:2018, 
#     factor = c(427,434.92,404.51,293.67,210,210)
#   )
# 
# pge_data <-
...
hdd %>% 
  ...
  geom_vline(aes(xintercept = 2019), color = "dark grey") +
  annotate("text",label= "Historical\n", color = "dark grey", x=2019, y=2600, angle = 90, size=4) +
  annotate("text",label= "\nForecast", color = "dark grey", x=2019, y=2600, angle = 90, size=4) +
  scale_colour_manual(values = c("red","blue")) + 
  labs(title = "Stockton, CA Heating and Cooling Degree Days", y = "Degree Days", colour = "")
```


A full forecast of energy usage will also depend on predicted changes in resident and job populations, which will lead to more buildings and more energy used in buildings, and many other factors that are outside the scope of this analysis.

The following table shows historical 2013-2018 annual energy usage per capita (residents for residential energy, jobs for commercial energy) per degree day (HDDs for gas, CDDs for electricity). 
...
The following table shows projections of electricity and gas usage to 2040, using the same assumptions from Section 2.1 of future population and jobs, and Cal-Adapt's HDD and CDD projections. We assume  We also assume PG&E's 2017 electricity emissions value of 210 lbs CO2 per MWh is fixed through 2040, though SB 100 signed into law September 2018 requires state energy agencies to adopt a 100 percent clean energy by 2045 planning goal.
...
summary_TCO2E_norm_all %>% 
  ...
  scale_colour_manual(values = c("red","red","blue")) +
  scale_linetype_manual(values = c("line","dashed","line")) + 
  labs(title = "Stockton, CA", y = "kBTU/cap/degree-day", colour = "")
```
...
pge_stockton_filtered <- pge_data %>% 
