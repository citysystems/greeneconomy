...
```{r img-microunit}
include_graphics("images/microunit.png")
```
...
```{r img-densitybonus}
include_graphics("images/densitybonus.png")
```
...
```{r img-hiphousing}
include_graphics("images/hiphousing.png")
```
...
```{r img-solar}
include_graphics("images/solar.png")
```
...
```{r img-srec}
include_graphics("images/srec.png")
```
...
```{r img-pace}
include_graphics("images/pace.png")
```
...
```{r img-bio}
include_graphics("images/bio.png")
```
