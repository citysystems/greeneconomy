...
map <- mapview(test_buildable_area, col.regions = "green", lwd=0, layer.name= "Buildable ADU Area") + 
...
map <- mapview(downtown_accessible_stops, layer.name= "Bus Stops")+
