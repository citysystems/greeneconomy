...
# save(stockton_parcels,stockton_parcels_extended,file="C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/Parcels/stockton_parcels.Rdata")
...
```{r}
# load("C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ca_blocks_lite.Rdata")
# 
# stockton_blocks <- st_transform(ca_blocks_lite,projection)[stockton_boundary_influence_projected,]
#   
# save(stockton_blocks, file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/stockton_blocks.Rdata")
```
...
# }
# save(adu_available_land, file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/adu_available_land.Rdata")
# 
...
#   st_as_sf()
# 
# save(yard_setbacks, house_setback, adu_available_land, yard_separation, file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/yard_separation.Rdata")
load("C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/yard_separation.Rdata")
```

```{r}
# save.image(file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/test_adu_save1.Rdata")
# load("C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/test_adu_save1.Rdata")
```
...
#   st_as_sf()
# 
# save(stockton_parcels_dissolve, file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/stockton_parcels_dissolve.Rdata")
# load("C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/stockton_parcels_dissolve.Rdata")
# 
...
#     rbind(street_edge)
#   
#   save(street_edges, file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/street_edges.Rdata")
# }
# 
# load("C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/street_edges.Rdata")
# 
...
# 
# save(street_edges, parcels_number_of_edges, through_lots_or_misc, corner_edges, file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/street_edges_analysis.Rdata")
load("C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/street_edges_analysis.Rdata")
...
```{r}
# save.image(file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/test_adu_save2.Rdata")
# load("C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/test_adu_save2.Rdata")
```
...
sspz <- st_read("C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/sspzboundary/sspzboundary.shp") %>% 
  st_transform(projection)
...
for(parcelRow in 38622:nrow(go)){
# for(parcelRow in 2006:3000){
...
# to-do: fix the large areas that do not become donuts because front yards are eliminated
...
clean_buildable_area <-
  ...
  st_buffer(2) %>% 
  st_buffer(-2) %>% 
  fill_holes(threshold = units::set_units(100000, ft^2)) %>% 
  as_Spatial() %>% 
  sp::disaggregate() %>% 
  st_as_sf() %>% 
  mutate(
...
```{r}
# save(go_collected_buildable_area, file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/sspz.Rdata")
# load("C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/sspz.Rdata")
```

```{r}
save.image(file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/test_adu_save3.Rdata")
# load("C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/test_adu_save3.Rdata")
```

```{r}
# save.image(file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/test_adu_save4.Rdata")
# load("C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/test_adu_save4.Rdata")
```