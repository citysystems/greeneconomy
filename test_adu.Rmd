...
# save(stockton_parcels,stockton_parcels_extended,file="C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/Parcels/stockton_parcels.Rdata")
...
load("C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/ADU/yard_separation.Rdata")
```

```{r}
# save.image(file = "C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/ADU/test_adu_save1.Rdata")
# load("C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/ADU/test_adu_save1.Rdata")
```
...
# 
# save(street_edges, parcels_number_of_edges, through_lots_or_misc, corner_edges, file = "C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/ADU/street_edges_analysis.Rdata")
load("C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/ADU/street_edges_analysis.Rdata")
...
```{r}
# save.image(file = "C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/ADU/test_adu_save2.Rdata")
# load("C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/ADU/test_adu_save2.Rdata")
```
...
sspz <- st_read("C:/Users/Derek Ouyang/Google Drive/City Systems/Stockton Green Economy/sspzboundary/sspzboundary.shp") %>% 
  st_transform(projection)
...
# for(parcelRow in 38621){
  ...
  if(parcelRow%%1000 == 0) save(go_collected_buildable_area, file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/go_collected_buildable_area.Rdata")
}
```
...
clean_buildable_area <-
  ...
  st_buffer(2) %>% 
  st_buffer(-2) %>% 
  fill_holes(threshold = units::set_units(1000000, ft^2)) %>% 
  as_Spatial() %>% 
  sp::disaggregate() %>% 
  st_as_sf() %>% 
  mutate(
...
```{r}
# save(go_collected_buildable_area, file = "C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/go_collected_buildable_area.Rdata")
# load("C:/Users/derek/Google Drive/City Systems/Stockton Green Economy/ADU/go_collected_buildable_area.Rdata")
```
...
downtown_accessible_stops <-
  ...
  filter(departures >= (end_hour-start_hour))
