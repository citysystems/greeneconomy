m_patterns_join_cleanse <- function(m_patterns, safegraphplaces){
  ...
  m_patterns_join <- dplyr::select(m_patterns_join, c("safegraph_place_id", "location_name", "name_address", "longitude", "latitude", "distance_from_home", "raw_visit_counts", "raw_visitor_counts", "visit_home_cbgs", "visitor_home_cbgs"))
